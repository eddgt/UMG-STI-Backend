    ...
    loginAuth(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const login = yield conne.query('SELECT \'usuario válido\' message, id, usuario, rol, id_rol, nombre, email FROM Usuarios WHERE email = ? and pass = ?', [newLogin.email, newLogin.pass]);
